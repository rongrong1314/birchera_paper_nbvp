...
(cl:in-package multiagent_collision_check-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Segment>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Segment)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multiagent_collision_check-msg:<Segment> is deprecated: use multiagent_collision_check-msg:Segment instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Segment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multiagent_collision_check-msg:header-val is deprecated.  Use multiagent_collision_check-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'poses-val :lambda-list '(m))
(cl:defmethod poses-val ((m <Segment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multiagent_collision_check-msg:poses-val is deprecated.  Use multiagent_collision_check-msg:poses instead.")
  (poses m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Segment>)))
  ...
  "multiagent_collision_check/Segment")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Segment)))
  "Returns string type for a message object of type 'Segment"
  "multiagent_collision_check/Segment")
