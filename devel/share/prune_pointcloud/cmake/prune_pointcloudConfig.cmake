...
if(NOT "/home/zs/Github/bircher_nbv/src/nbvplanner/prune_pointcloud/include " STREQUAL " ")
  set(prune_pointcloud_INCLUDE_DIRS "")
  set(_include_dirs "/home/zs/Github/bircher_nbv/src/nbvplanner/prune_pointcloud/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'prune_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zs/Github/bircher_nbv/src/nbvplanner/prune_pointcloud/${idir}'.  ${_report}")
    endif()
